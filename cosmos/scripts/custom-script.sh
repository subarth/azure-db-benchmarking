...
echo "###########YCSB_DATABASE_NAME########: $YCSB_DATABASE_NAME"
...
# Setting up logrotate for perpetually running workloads to avoid disk space issues.
